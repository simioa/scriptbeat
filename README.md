...
`${GOPATH}/src/github.com/simioa/scriptbeat`
...
```
git remote set-url origin https://github.com/simioa/scriptbeat
...
in the same directory with the name scriptbeat.
...
```
./scriptbeat -c scriptbeat.yml -e -d "*"
```
...
```
mkdir -p ${GOPATH}/src/github.com/simioa/scriptbeat
git clone https://github.com/simioa/scriptbeat ${GOPATH}/src/github.com/simioa/scriptbeat
```
